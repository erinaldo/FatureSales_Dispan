namespace AppLib.Padrao
{
    partial class FormMenuVisao
    {
        ...
        "SELECT CODMENU, NOME, TELACONSULTA, TELACADASTRO, ATIVO",
        "FROM ZMENU"};
            this.grid1.NomeGrid = "ZMENU";
            ...
            this.Name = "FormMenuVisao";
            this.Text = "Visão de Menu";
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormMenuVisao_FormClosed);
            this.Load += new System.EventHandler(this.FormMenuVisao_Load);
