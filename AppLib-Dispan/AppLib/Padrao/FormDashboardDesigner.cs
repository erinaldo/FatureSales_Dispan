...
{
    public partial class FormDashboardDesigner : DevExpress.XtraBars.Ribbon.RibbonForm
    {
        public String Conexao { get; set; }
        public String ArquivoXML { get; set; }

        public FormDashboardDesigner()
        {
            InitializeComponent();
        }

        private void dashboardDesigner1_ConfigureDataConnection(object sender, DevExpress.DataAccess.Sql.ConfigureDataConnectionEventArgs e)
        {
