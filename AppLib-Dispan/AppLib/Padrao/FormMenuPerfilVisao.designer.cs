...
{
    partial class FormMenuPerfilVisao
    {
        /// <summary>
        ...
        "SELECT *",
        "FROM ZMENUPERFIL"};
            this.grid1.NomeGrid = "ZMENUPERFIL";
            ...
            this.Name = "FormMenuPerfilVisao";
            this.Text = "Visão de Menu/Perfil";
            this.FormClosed += new System.Windows.Forms.FormClosedEventHandler(this.FormMenuPerfilVisao_FormClosed);
            this.Load += new System.EventHandler(this.FormMenuPerfilVisao_Load);
