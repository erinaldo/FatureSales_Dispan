...
{
    public partial class FormReportPerfilCadastro : AppLib.Windows.FormCadastroData
    {
        public FormReportPerfilCadastro()
        {
            InitializeComponent();
        }

        private void FormReportPerfilCadastro_Load(object sender, EventArgs e)
        {

        }

        private void FormReportPerfilCadastro_AntesSalvar(object sender, EventArgs e)
        {
