...
{
    public partial class FiguraTransacao
    {
        ...
        public FiguraTransacao(CaixaTexto Caixa1, System.Drawing.Graphics graph)
        {
            Caixa = Caixa1;
        ...
        {
            FormFiguraTransacao f = new FormFiguraTransacao(this, ListaDestino, NomeFluxo);
            f.ShowDialog();
        }

        public FiguraTransacao Copiar()
        {
            CaixaTexto caixaTextoTemp = new CaixaTexto();
            caixaTextoTemp.CopiarCaixaTexto(this.Caixa, caixaTextoTemp);

            FiguraTransacao objDestino = new FiguraTransacao(caixaTextoTemp, Graphic);
