...
{
    public partial class FiguraSubprocesso
    {
        ...
        public List<VariaveisSubprocesso> Variaveis = new List<VariaveisSubprocesso>();
        ...
        public FiguraSubprocesso(CaixaTexto Caixa1, System.Drawing.Graphics graph)
        {
            Caixa = Caixa1;
        ...
        public void Editar(Object[] ListaDestino, List<VariaveisFluxo> Variaveis)
        {
            FormFiguraSubprocesso f = new FormFiguraSubprocesso(this, ListaDestino, Variaveis);
            f.ShowDialog();
        }

        public FiguraSubprocesso Copiar()
        {
            CaixaTexto caixaTextoTemp = new CaixaTexto();
            caixaTextoTemp.CopiarCaixaTexto(this.Caixa, caixaTextoTemp);

            FiguraSubprocesso objDestino = new FiguraSubprocesso(caixaTextoTemp, Graphic);

            objDestino.Nome = this.Nome;
            objDestino.Destino = this.Destino;
            objDestino.Subprocesso = this.Subprocesso;
