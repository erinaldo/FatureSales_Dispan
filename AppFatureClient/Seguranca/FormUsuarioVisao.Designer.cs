...
{
    partial class FormUsuarioVisao
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormUsuarioVisao));
        ...
        "SELECT * FROM ZUSUARIO"};
            this.grid1.NomeGrid = "ZUSUARIO";
            ...
            this.Name = "FormUsuarioVisao";
            this.Text = "Visão de Usuário";
            this.Load += new System.EventHandler(this.FormUsuarioVisao_Load);
