...
{
    public partial class RelTabPrecoRevendaCompostoSipi : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RelTabPrecoRevendaCompostoSipi()
        {
            InitializeComponent();
        }
 ...
 TPRODUTO.NUMEROCCF,
 (TITMMOV.QUANTIDADEORIGINAL * TITMMOV.PRECOUNITARIO) TOTAL,
 ...
 *
 ...
 AND CODCOLIGADA = TMOV.CODCOLIGADA),0)/100),0) VALOR_COM_DESCONTO
