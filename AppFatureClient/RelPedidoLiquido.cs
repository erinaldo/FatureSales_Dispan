...
{
    public partial class RelPedidoLiquido : DevExpress.XtraReports.UI.XtraReport
    {
...
AND TITMMOV.IDMOV = ?";
            ...
            //
            txtPRECOUNITARIO.Visible = false;
...
ORDER BY TT.NUMEROSEQUENCIAL";
            ...
            //
            txtPRECOUNITARIO4.Visible = false;
            txtVALORTOTAL4.DataBindings.Add("Text", null, "VALORTOTAL", "{0:n}");
            //
            txtVALORTOTAL4.Visible = false;
        }
        ...
        private void GroupFooter1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            if (Convert.ToDecimal(txtQUANTIDADE.Text) == 0)
            {
                ...
                //
                txtTOTALIZADORVALORTORAL1.Visible = false;
            }
            ...
            else
            {
                ...
                //
                txtTOTALIZADORPRECOUNITARIO1.Visible = false;
            }
        ...
        private void DetailReport5_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            //
            txtSUBTOTALGERAL.Visible = false;
