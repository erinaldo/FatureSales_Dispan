...
AND TMOV.IDMOV = TMOVHISTORICO.IDMOV";
        ...
        private void Detalhe1()
        {
            ...
            //LEFT OUTER JOIN TPRDCOMPL ON TPRDCOMPL.IDPRD = TPRD.IDPRD
...
";
        ...
        private void Detalhe2()
        {
            ...
            //            string sSql = @"SELECT TM.IDMOV, TT.NUMEROSEQUENCIAL, CAST(ISNULL(TCPL.DESCPADRAO,'') AS VARCHAR (8000))+ '   '+  ISNULL(CAST(TH.HISTORICOLONGO AS VARCHAR (8000)),'') + '   '+ 
...
ORDER BY TT.NUMEROSEQUENCIAL";
        ...
        private void DetailReport1_BandHeightChanged(object sender, BandEventArgs e)
        {
