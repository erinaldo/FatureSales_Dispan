...
{
    public partial class FormSelecionaNFParaRateio : DevExpress.XtraEditors.XtraForm
    {
        #region PROPRIEDADES
        ...
        public FormSelecionaNFParaRateio()
        {
            InitializeComponent();
        ...
        {
            clNF.ColunaTabela = @"(Select TM.CODCOLIGADA,
                                           TM.IDMOV,
                                           TM.NUMEROMOV,
                                           FCFO.NOME,
                                           TM.TIPO,
                                    ...
                                    on TTM.CODCOLIGADA = TM.CODCOLIGADA
                                    and TTM.IDMOV = TM.IDMOV
                                    ...
                                    and TM.CODTMV = '1.2.65' 
                                    and TM.CODCFO = '00918' 
                                    and TM.STATUS <> 'c'
                                    and TTM.IDPRD in ('39996','41523','40002','42289', '39999', '45449')
									and TM.DATAEMISSAO >= '2019-09-17'
                                    and TM.IDMOV not in (select IDMOV from ZOPRATEADAS)
                                    and TMC.USARATNFOP = 1) W";

            clNF.ColunaCodigo = "NUMEROMOV";
            clNF.ColunaDescricao = "NOME";
        }
        ...
        private void clNF_Leave(object sender, EventArgs e)
        {
            if (clNF.textBoxCODIGO.EditValue != null)
            {
                AppFatureClient.New.Class.Utilities util = new AppFatureClient.New.Class.Utilities();

                if (!util.ExisteCampo(clNF))
                {
