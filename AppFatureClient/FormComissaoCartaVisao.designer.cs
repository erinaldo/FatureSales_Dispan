...
{
    partial class FormComissaoCartaVisao
    {
        /// <summary>
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(FormComissaoCartaVisao));
        ...
        "\t   TRPR.NOME,",
        "\t   TRPR.NOMEFANTASIA, ",
        "\t   (ZCC.VALORCREDITO + ZCC.VALORCREDITOCOMPL) - (ZCC.VALORDEBITO + ZCC.VALORDEBI" +
            "TOCOMPL) as \'TOTAL\',",
        "\t   ZCC.VALORCREDITO,",
        "\t   ZCC.VALORCREDITOCOMPL,",
        "\t   ZCC.VALORDEBITO,",
        "\t   ZCC.VALORDEBITOCOMPL,",
        "\t   ZCC.STATUS,",
        "\t   ZCC.USUARIOCRIACAO,",
        "\t   ZCC.DATACRIACAO,",
        "\t   ZCC.USUARIOALTERACAO,",
        "\t   ZCC.DATAALTERACAO",
        "",
        "from ZCOMISSAOCARTA ZCC",
        "",
        "inner join TRPR",
        "on TRPR.CODRPR = ZCC.CODRPR"};
            ...
            this.grid1.NomeGrid = "ZVWCOMISSAOCARTA";
        ...
        "and FCFC2.PAGREC = 1"};
            ...
            this.Name = "FormComissaoCartaVisao";
            this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
            this.Text = "Consulta de Carta";
